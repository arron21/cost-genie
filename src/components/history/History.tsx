...
const History = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <h1 className="text-2xl font-bold mb-6">Cost History</h1>
                  ...
                  <div className="flex items-center">
                    ...
                    >
                      {cost.favorite ? (
                        ...
                        <svg className="w-5 h-5 text-gray-400 hover:text-yellow-500" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                    ...
                    >
                      {cost.need ? (
                        ...
                        <svg className="w-5 h-5 text-gray-400 hover:text-indigo-500" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                        ...
                        {editingFrequencyId === cost.id ? (
                          <div className="flex items-center" onClick={e => e.stopPropagation()}>
                            <select
                              ...
                              className="mr-2 text-sm border border-gray-300 rounded px-1 py-0.5"
                            >
